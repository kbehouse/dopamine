...
from fetch_cam import rotations, robot_env, utils
...
class FetchEnv(robot_env.RobotEnv):
    ...
    def _get_obs_only_cam(self):
        rgb_gripper = self.sim.render(width=256, height=256, camera_name="gripper_camera_rgb", depth=False,
