...
def go_obj_savepic_siamese(is_render = True, hsv_color = False, rand_pick_obj = False, noise = False):
    ...
    env = FetchDiscreteCamSiamenseEnv(dis_tolerance = 0.001, step_ds=0.005, 
                        img_type=False, is_render=True, hsv_color = hsv_color)
    s_time = time.time()
    all_ep_steps = 0
...
# go_obj_savepic_with_camenv(img_type=False)
go_obj_savepic_with_camenv(img_type=IMG_TYPE.RGB, noise=False, is_render=True, only_show_obj0 = True)
