...
cv2.createTrackbar('h', 'result',174,179,nothing)
cv2.createTrackbar('s', 'result',211,255,nothing)
cv2.createTrackbar('v', 'result',41,255,nothing)

cv2.createTrackbar('h_u', 'result',179,179,nothing)
