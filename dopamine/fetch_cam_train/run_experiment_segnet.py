...
def create_fetch_cam_environment():
  env = FetchDiscreteCamEnv(dis_tolerance = 0.001, step_ds=0.005, gray_img=False, use_tray = False, is_render = False)
  return env
...
class Runner(object):
  ...
  def __init__(self,
    ...
    config.gpu_options.per_process_gpu_memory_fraction = 0.76
